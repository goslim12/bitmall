...
<!-------------------------------------------------------------------------------------------->	
			...
			<!-- form2 시작  -->
			<form name="form2" method="post" action="order/order_pay">
			<table width="710" border="0" cellpadding="0" cellspacing="0" class="cmfont">
				<tr>
					...
					<td align="center" width="560">
						...
						<table width="560" border="0" cellpadding="0" cellspacing="0" class="cmfont">
							...
							<tr height="25">
								...
								<td width="20"><b>:</b></td>
								<td width="390">
									<input type="text" name="o_tel1" size="4" maxlength="4" value="${o_tel[0]}" class="cmfont1"> -
									<input type="text" name="o_tel2" size="4" maxlength="4" value="${o_tel[1]}" class="cmfont1"> -
									<input type="text" name="o_tel3" size="4" maxlength="4" value="${o_tel[2]}" class="cmfont1">
								</td>
							</tr>
							<tr height="25">
								...
								<td width="20"><b>:</b></td>
								<td width="390">
									<input type="text" name="o_phone1" size="4" maxlength="4" value="${o_phone[0]}" class="cmfont1"> -
									<input type="text" name="o_phone2" size="4" maxlength="4" value="${o_phone[1]}" class="cmfont1"> -
									<input type="text" name="o_phone3" size="4" maxlength="4" value="${o_phone[2]}" class="cmfont1">
								</td>
							</tr>
							<tr height="25">
							...
							<tr height="50">
								...
								<td width="20"><b>:</b></td>
								<td width="390">
									<input type="text" name="o_zip1" size="3" maxlength="3" value="${o_zip[0]}" class="cmfont1" readonly> -
									<input type="text" name="o_zip2" size="3" maxlength="3" value="${o_zip[1]}" class="cmfont1" readonly>
									...
									<input type="text" name="o_juso" size="50" maxlength="200" value="${o_juso}" class="cmfont1" readonly><br>
								</td>
							</tr>
						</table>
