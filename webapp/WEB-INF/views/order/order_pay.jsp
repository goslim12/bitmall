...
<!-------------------------------------------------------------------------------------------->	
						...
						<td height="60" align="center">
							<table cellpadding="0" cellspacing="0" width="100%">
								<tr>
									...
									<td class="cmfont">
										<a href="${pageContext.servletContext.contextPath }/product/product_detail?no=${map[vo.productNo].no}"><font color="#0066CC">${map[vo.productNo].title}</a><br>
										<font></font>
									</td> 
								</tr>
							</table>
						</td>
						<td align="center"><font color="#464646">${vo.count}&nbsp개</font></td>
						<td align="center"><font color="#464646">${map[vo.productNo].price}</font> 원</td>
						<td align="center"><font color="#464646">${(map[vo.productNo].price)*vo.count}</font> 원</td>
					</tr>
					...
					<td colspan="5" bgcolor="#F0F0F0">
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="cmfont">
							<tr>
								...
								<font color="#0066CC"><b>총 합계금액</font></b> : 상품대금(${sum}원) + 배송료(2,500원) = <font color="#FF3333"><b>${sum+2500} 원</b></font>&nbsp;&nbsp								</td>
							</tr>
						</table>
					</td>
				</tr>
			...
			<input type="hidden" name="o_name"   value="${authUser.name}">
			<input type="hidden" name="o_tel"    value="${authUser.telephone}">
			<input type="hidden" name="o_phone"  value="${authUser.phone}">
			<input type="hidden" name="o_email"  value="${authUser.email}">
			<input type="hidden" name="o_zip"    value="${authUser.zip}">
			<input type="hidden" name="o_addr"   value="${authUser.address}">
			...
			<input type="hidden" name="r_addr"   value="${r_addr}">
			<input type="hidden" name="o_etc"    value="${o_etc}">
				...
				<tr>
					...
					<td align="center" width="560">
						...
						<table width="560" border="0" cellpadding="0" cellspacing="0" class="cmfont">
							<tr height="25">
								<td width="150"><b>결제방법 선택</b></td>
								<td width="20"><b>:</b></td>
								<td width="390">
									<input type="radio" name="pay_method" value="카드" onclick="javascript:PaySel(0);" checked>카드 &nbsp;
									<input type="radio" name="pay_method" value="무통장" onclick="javascript:PaySel(1);">무통장
								</td>
							</tr>
						</table>
					</td>
