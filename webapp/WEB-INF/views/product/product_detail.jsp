...
<head>
	...
	<script language="javascript">
		function func() {
			...
			window.location.href = "${pageContext.servletContext.contextPath}/cart/cartadd?num="+ num+"&no=${no}"; 
		}
	</script>
</head>
<body style="margin:0">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="370" class="cmfont">
							...
							<tr>
								...
								<td style="padding-left:10px">
									<font color="282828">${vo.title}</font><br>
							...
							<tr>
								...
								<td width="1" bgcolor="E8E7EA"></td>
								<td width="289" style="padding-left:10px"><font color="666666">${vo.price} 원</font></td>
							</tr>
							<tr><td colspan="3" bgcolor="E8E7EA"></td></tr>
							<!-- 판매가 -->
							<tr>
								...
								<td width="1" bgcolor="E8E7EA"></td>
								<td style="padding-left:10px"><font color="0288DD"><b>${vo.price} 원</b></font></td>
							</tr>
							<tr><td colspan="3" bgcolor="E8E7EA"></td></tr>
							<!-- 옵션 -->
							<tr>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="370" class="cmfont">
							<tr>
								<td height="70" align="center">
									...
									<a onclick="func();"><img src="${pageContext.servletContext.contextPath }/assets/images/b_cart.gif"  border="0" align="absmiddle"></a>
								</td>
							</tr>
						</table>
						<table border="0" cellpadding="0" cellspacing="0" width="370" class="cmfont">
