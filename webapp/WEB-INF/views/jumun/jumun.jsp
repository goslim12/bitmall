...
<!-------------------------------------------------------------------------------------------->	
			...
			<table border="0" cellpadding="0" cellspacing="0" width="685" class="cmfont">
				...
				<c:forEach items="${list}" var="vo" varStatus="status">
					<tr>
						<td height="30" align="center"><font color="686868">${vo.date}</font></td>
						<td align="center">
							<a href="${pageContext.servletContext.contextPath }/jumun/info?no=${vo.orderKeyNo}"><font color="#0066CC">${vo.orderNo}</font></a>
						</td>
						<td><font color="686868">${vo.title}</font></td>
						<td align="right"><font color="686868">${vo.price} 원</font></td>
						<td align="center"><font color="#0066CC">${vo.state}</font></td>
					</tr>
